...
namespace UWPX_UI.Controls.DataForms
{
    public sealed partial class TextSingleFieldControl: UserControl
    {
        ...
        public static readonly DependencyProperty FieldProperty = DependencyProperty.Register(nameof(Field), typeof(Field), typeof(TextSingleFieldControl), new PropertyMetadata(null, OnFieldChanged));
        ...
        private void UpdateView()
        {
            ...
            if (!(Field is null))
            {
                ...
                // Options:
                textSingle_tbx.IsReadOnly = Field.dfConfiguration.flags.HasFlag(DynamicFormsFlags.READ_ONLY);
            }
        }
