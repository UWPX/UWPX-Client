...
namespace UWPX_UI.Controls.Chat.SpeechBubbles.Content
{
    public sealed partial class SpeechBubbleErrorStatusBarControl : UserControl
    {
        ...
        public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(nameof(ViewModel), typeof(SpeechBubbleContentContext), typeof(SpeechBubbleErrorStatusBarControl), new PropertyMetadata(null));
