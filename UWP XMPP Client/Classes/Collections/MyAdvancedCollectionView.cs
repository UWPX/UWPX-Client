...
namespace UWP_XMPP_Client.Classes.Collections
{
    ...
    /// A collection view implementation that supports filtering, sorting and incremental loading
    /// </summary>
    public partial class MyAdvancedCollectionView : IAdvancedCollectionView, INotifyPropertyChanged, ISupportIncrementalLoading, IComparer<object>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MyAdvancedCollectionView"/> class.
        /// </summary>
        public MyAdvancedCollectionView()
        ...
        public MyAdvancedCollectionView(IList source, bool isLiveShaping = false)
        {
            ...
            set
            {
                ...
                if (_source is INotifyCollectionChanged sourceNcc)
                {
                    _sourceWeakEventListener =
                        new WeakEventListener<MyAdvancedCollectionView, object, NotifyCollectionChangedEventArgs>(this)
                        {
