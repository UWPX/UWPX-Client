...
namespace UWP_XMPP_Client.Controls
{
    public sealed partial class SpeechBubbleInfoControl : UserControl
    {
        ...
        public static readonly DependencyProperty ChatMessageProperty = DependencyProperty.Register(nameof(ChatMessage), typeof(ChatMessageTable), typeof(SpeechBubbleInfoControl), null);
